...
graph TD
    subgraph Meta-Swarm Evolution Pipeline
        O[👁️ Observer] -->|JSON Score Matrix| B[🔍 Bottleneck]
        B -->|Failing Agent + Missing Instruction| R[✍️ Refactor]
        R -->|v2.0 Candidate Prompt| S[👥 Shadow]
        S -->|A/B Testing Outputs| E[⚖️ Eval]
        E -->|Win/Loss Assessment| P[🚀 Promotion]
    end

    P -. "Hot-Swaps System Prompt" .-> Registry[(Cosmos / Local Registry)]
```
